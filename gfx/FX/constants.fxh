...
static const float GB_CAM_MIN = 150.0f;
...
static const float BORDER_FOW_REMOVAL_FACTOR = .4f; // How much of the FOW that is removed from the borders. 1.0f is no FOW
